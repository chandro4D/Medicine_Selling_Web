...
const SellerAd = () => {
    ...
    const handleAddItem = e => {
        ...
        axiosPublic.post('/adds', addItem)
            .then(res => {
                if (res.data.insertedId) {
                    Swal.fire({
                        icon: "success",
                        text: "ADDED NEW ITEM FOR ADVERTISEMENT SUCCESSFULLY!",
    ...
    return (
        <div>
            <div>
                <h3 className="pt-14 ml-40 text-center font-semibold text-3xl text-indigo-500  mb-10">ALL OF YOUR REFERRED ITEM HERE</h3>
            </div>
            ...
            <div className="ml-[400px] mb-10 ">
                <button className="ml-[48 0px]">{/* Open the modal using document.getElementById('ID').showModal() method */}
                    <button className="btn text-white  bg-gradient-to-r from-indigo-500  to-pink-500 " onClick={() => document.getElementById('my_modal_5').showModal()}>ASK FOR ADVERTISEMENT</button>
                        ...
                        <div className="modal-box w-[900px] h-[500px] bg-gradient-to-r from-indigo-500  to-pink-500">
                            ...
                            <form onSubmit={handleAddItem} className=" ">
                                ...
                                <div className=" lg:w-[400px] sm:w-[250px] ml-8  h-[50px] rounded-2xl">
                                    <button className=" btn btn-outline btn-secondary w-full h-full "> ASK FOR ADVERTISEMENT</button>
                                </div>
                            </form>
